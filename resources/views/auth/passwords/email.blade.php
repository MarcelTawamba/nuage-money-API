            ...
            <div class="login-form">
                ...
                <div class="card-body login-card-body">
                    ...
                    <form action="{{ route('password.email') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button style="border-radius: 1rem" type="submit" class="btn btn-primary btn-block">Send Password Reset Link</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
                    ...
                    <div class="d-flex justify-content-between mt-4 mb-1">
                        <a href="{{ route("login") }}">Login</a><a href="{{ route("register") }}" class="text-center">Register now</a>
                    </div>
